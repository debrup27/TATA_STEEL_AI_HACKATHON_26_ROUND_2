              ...
              <div className="flex flex-col items-center gap-8 -mt-24">
                ...
                <div className="text-center">
                  ...
                  <p className="mt-1 text-sm md:text-base font-semibold text-zinc-500">
                    The Frontier at Your Fingertips
                  </p>
                </div>
              </div>
                    ...
                    <Steps defaultOpen>
                      ...
                      <StepsContent>
                        <div className="space-y-1">
                          {deepThinking ? (
                            <>
                              <StepsItem status={currentStep > 0 ? "complete" : currentStep === 0 ? "active" : "pending"}>Reasoning through the problem</StepsItem>
                              <StepsItem status={currentStep > 1 ? "complete" : currentStep === 1 ? "active" : "pending"}>Weighing alternatives</StepsItem>
                              <StepsItem status={currentStep > 2 ? "complete" : currentStep === 2 ? "active" : "pending"}>Formulating response</StepsItem>
                            </>
                          ) : (
                            <>
                              <StepsItem status={currentStep > 0 ? "complete" : currentStep === 0 ? "active" : "pending"}>Analyzing input</StepsItem>
                              <StepsItem status={currentStep > 1 ? "complete" : currentStep === 1 ? "active" : "pending"}>
                                <Source href="https://example.com">
                                  <SourceTrigger label="example.com" showFavicon />
                                  <SourceContent
                              ...
                              <StepsItem status={currentStep > 2 ? "complete" : currentStep === 2 ? "active" : "pending"}>Generating response</StepsItem>
                            </>
                          )}
                        </div>
                      </StepsContent>
