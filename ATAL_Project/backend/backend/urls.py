...
urlpatterns = [
    ...
    path("api/v1/notifications/", include("apps.alerts.notifications_urls")),
    path("api/v1/diagnostics/", include("apps.assets.urls.diagnostics")),
    path("api/v1/glossary/", include("apps.assets.urls.glossary")),
